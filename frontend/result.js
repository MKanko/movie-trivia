class Result {
    ...
    static generateResult(json) {
        ...
        const ansArr = json.included.map(function (element) {
            return new Answer(element.attributes.question_number, element.attributes.question, 
                element.attributes.selected_answer, element.attributes.correct_answer, 
                element.attributes.answer_context)
        })
